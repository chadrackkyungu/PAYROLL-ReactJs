...
// import { NotificationPositionsBottomCenter } from "../../components/Notifications/Notifications";
...
const Login = () => {
  ...
  const NotificationPositionsBottomCenter = () => {
  ...
  const rightSide = (
    <div className="sw-lg-70 min-h-100 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
      <div className="sw-lg-50 px-5">
        ...
        <div className="mb-5">
          <h2 className="cta-1 mb-0 text-primary p-2 mb-5">{loginError}</h2>
