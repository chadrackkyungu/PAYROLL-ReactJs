...
const Login = () => {
  ...
  const rightSide = (
    <div className="sw-lg-70 min-h-100 bg-foreground d-flex flex-column justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
      <div className="sh-11">
