                        ...
                        <Form onSubmit={handleSubmit} className="tooltip-end-top">
                            ...
                            <Row>
                                <div className="mb-3 filled">
                                    ...
                                    <Select classNamePrefix="react-select" placeholder="Select Category" name="category" options={category} value={categoryValue} onChange={categoryOnChange} placeholder="Select leave type" />
                                    {errors.category && touched.category && <div className="error">{errors.category}</div>}
                                </div>

                                <div className="mb-3 filled">
                                    <CsLineIcons icon="loaf" />
                                    <Select classNamePrefix="react-select" name="types" options={types} value={typeValue} onChange={typeOnChange} placeholder="Select leave type" />
