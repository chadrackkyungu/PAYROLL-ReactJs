                        ...
                        <Form onSubmit={handleSubmit} className="tooltip-end-top">
                            ...
                            <Row>
                                <div className="mb-3 filled">
                                    ...
                                    <Form.Control name="category" onChange={handleChange} placeholder="Salary Amount" />
                                    {errors.category && touched.salaryAmount && <div className="error">{errors.category}</div>}
                                </div>

                                <div className="mb-3 filled">
                                    <CsLineIcons icon="dollar" />
                                    <Form.Control name="types" onChange={handleChange} placeholder="Salary Overtime Amount" />
                                    {errors.types && touched.types && <div className="error">{errors.types}</div>}
                                </div>

                                <div className="mb-3 filled">
                                    <CsLineIcons icon="clock" />
                                    <Form.Control className="form-control" name="message" onChange={handleChange} placeholder="Hours Worked" />
