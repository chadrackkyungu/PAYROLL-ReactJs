                        ...
                        <Form onSubmit={handleSubmit} className="tooltip-end-top">
                            ...
                            <Row>
                                <div className="mb-3 filled">
                                    ...
                                    <Select classNamePrefix="react-select" name="category" options={category} value={categoryValue} onChange={categoryOnChange} placeholder="Select leave type" />
                                    {errors.category && touched.category && <div className="error">{errors.category}</div>}
                                </div>

                                {/* <div className="mb-3 filled">
                                    <CsLineIcons icon="loaf" />
                                    <Select classNamePrefix="react-select" name="types" options={options} value={selectValue} onChange={selectOnChange} placeholder="Select leave type" />
