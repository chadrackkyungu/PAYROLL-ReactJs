    ...
    const [dataDb, setData] = useState([
        {
            ...
            end_date: "2022-07-14",
            view: <Badge bg="info"> <Link to="#/" className="p-2 text-white"> View </Link>  </Badge>,
            status: <Badge bg="success"> <Link to="#/" className="p-2 text-white"> Approved </Link>  </Badge>,
        ...
        },
        {
            ...
            end_date: "2022-07-14",
            view: <Badge bg="info"> <Link to="#/" className="p-2 text-white"> View </Link>  </Badge>,
            status: <Badge bg="danger"> <Link to="#/" className="p-2 text-white"> Decline </Link>  </Badge>,
            edit: <Badge pill bg="primary">  <Link to="#/" className="p-2 text-white"> Edit </Link> </Badge>,
        ...
        },
        {
            ...
            end_date: "2022-07-14",
            view: <Badge bg="info"> <Link to="#/" className="p-2 text-white"> View </Link>  </Badge>,
            status: <Badge bg="danger"> <Link to="#/" className="p-2 text-white"> Approved </Link>  </Badge>,
            edit: <Badge pill bg="primary">  <Link to="#/" className="p-2 text-white"> Edit </Link> </Badge>,
