    ...
    const [dataDb, setData] = useState([
        {
            ...
            end_date: "2022-07-14",
            view: <Badge bg="success"> <Link to="#/" className="text-white"> <CsLineIcons icon="eye" size={15} className="text-white" /> view </Link>  </Badge>,
            status: <Badge bg="success">  Approved   </Badge>,
            edit: <Badge pill bg="primary">  <Link to="#/" > <CsLineIcons icon="pen" size={15} className="text-white" /> </Link> </Badge>,
        },
        {
            type: 'Sick',
            start_date: "2022-07-14",
        ...
        },
        {
            ...
            edit: <Badge pill bg="primary">  <Link to="#/" className="text-white"> <CsLineIcons icon="pen" size={15} className="text-white" /> edit </Link> </Badge>,
