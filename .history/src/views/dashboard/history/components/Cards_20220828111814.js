        ...
        <div>
            <Row className="g-2">
                <Col lg="6" xxl="3">
                    <Card>
                        <Card.Body>
                            <Row className="g-0 align-items-center view overlay">
                                <Col xs="auto">
                                    <div className="bg-gradient-light sw-6 sh-6 rounded-md d-flex justify-content-center align-items-center">
                                        <CsLineIcons icon="eye" className="text-white img-fluid" />
                                    </div>
                                </Col>
                                <Col className="sh-6 ps-3 d-flex flex-column justify-content-center mask rgba-red-strong">
