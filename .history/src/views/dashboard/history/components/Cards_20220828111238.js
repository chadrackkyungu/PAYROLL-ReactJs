                    ...
                    <Card>
                        <Card.Body>
                            <Row className="g-0 align-items-center">
                                ...
                                <Col className="sh-6 ps-3 d-flex flex-column justify-content-center">
                                    <div className="heading mb-0 d-flex align-items-center lh-1-25">Pending</div>
                                    <Row className="g-0">
                                        <Col xs="auto">
                    ...
                    <Card>
                        <Card.Body>
                            <Row className="g-0 align-items-center">
                                ...
                                <Col className="sh-6 ps-3 d-flex flex-column justify-content-center">
                                    <div className="heading mb-0 d-flex align-items-center lh-1-25">Approved</div>
                                    <Row className="g-0">
                                        <Col xs="auto">
                    ...
                    <Card>
                        <Card.Body>
                            <Row className="g-0 align-items-center">
                                ...
                                <Col className="sh-6 ps-3 d-flex flex-column justify-content-center">
                                    <div className="heading mb-0 d-flex align-items-center lh-1-25">Declined</div>
                                    <Row className="g-0">
                                        <Col xs="auto">
