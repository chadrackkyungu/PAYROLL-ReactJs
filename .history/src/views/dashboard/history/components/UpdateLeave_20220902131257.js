...
function UpdateLeave(props) {
    ...
    const leaveObj = Object.assign(...leave); console.log(leaveObj);
    ...
    const initialValues = { message: leaveObj.message, select: leaveObj.leaveType, leaveStartDate: "", leaveEndDate: "" };
