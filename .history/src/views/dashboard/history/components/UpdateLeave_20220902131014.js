...
function UpdateLeave(props) {
    ...
    const initialValues = { message: leaveObj.message, select: leaveObj.leaveType, leaveStartDate: leaveObj.leaveStartDate, leaveEndDate: leaveObj.leaveEndDate };
