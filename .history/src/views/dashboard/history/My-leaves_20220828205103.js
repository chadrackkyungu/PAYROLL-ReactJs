    ...
    const [dataDb, setData] = useState([
        {
            ...
            edit: <Badge pill bg="primary">  <Link to="#/" > <CsLineIcons icon="edit" size={15} className="text-white" /> </Link> </Badge>,
        },
        {
            type: 'Sick',
            start_date: "2022-07-14",
            ...
            edit: <Badge pill bg="primary">  <Link to="#/" > <CsLineIcons icon="edit" className="text-white" /> </Link> </Badge>,
