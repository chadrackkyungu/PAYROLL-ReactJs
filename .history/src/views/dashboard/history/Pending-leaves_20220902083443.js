                                        ...
                                        <tbody>
                                            {newArray.map((leave, key) => (
                                                <tr key={"_tr_" + key}>
                                                    ...
                                                    <td> <Link to="#/" className="text-body fw-bold">{leave.id}</Link></td>
                                                    <td>{leave.billingName}</td>
                                                    <td>{leave.Date}</td>
                                                    <td>{leave.total}</td>
                                                    <td>
                                                        <Badge
                                                            className={
                                                                "font-size-11 badge-soft-" + leave.badgeClass
                                                            }
                                                            color={leave.badgeClass}
                                                            pill
                                                        >
                                                            {leave.paymentStatus}
                                                        </Badge>
                                                    ...
                                                    <td>
                                                        <i className={"fab " + leave.methodIcon + " me-1"}></i>
                                                        {leave.paymentMethod}
                                                    </td>
                                                    <td>
                                                        <Button
