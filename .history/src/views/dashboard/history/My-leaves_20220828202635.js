...
import { Row, Col, Badge, Card, <Button:reset></Button:reset> } from 'react-bootstrap';
...
const MyLeaves = () => {
    ...
    const [dataDb, setData] = useState([
        ...
        },
        {
            ...
            start_date: "2022-07-14",
            end_date: "2022-07-14",
            view: <Button variant="quaternary" className="btn-icon btn-icon-only mb-1"> <CsLineIcons icon="mic" /></Button>,
            edit: <Button variant="quaternary" className="btn-icon btn-icon-only mb-1"> <CsLineIcons icon="mic" /></Button>,
