...
const Pending = () => {
    ...
    const token = currentUser.data.user.token ? currentUser.data.user.token : null
    ...
    myHeaders.append("Cookie", "jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzMTA0NmI4NjMwNmI5N2M4ZjM2ZGJjNyIsImlhdCI6MTY2MjA1NjE1MCwiZXhwIjoxNjY5ODMyMTUwfQ.WFP1LNSTPKJzzW5f6lWETvzW529e7KU_GJwMyC1HLUA");
