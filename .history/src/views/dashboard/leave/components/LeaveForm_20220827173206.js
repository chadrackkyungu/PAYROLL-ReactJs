            ...
            <Row>
                <Col m={6}>
                    <div className="mb-3 filled">
                        ...
                        <DatePicker className="form-control" name="leaveStartDate" selected={values.startDate} onChange={startDateOnChange} placeholderText="Start Date" />
                ...
                <Col m={6}>
                    <div className="mb-3 filled">
                        <CsLineIcons icon="calendar" />
                        <DatePicker className="form-control" name="leaveEndDate" selected={values.endDate} onChange={endDateOnChange} placeholderText="End Date" />
