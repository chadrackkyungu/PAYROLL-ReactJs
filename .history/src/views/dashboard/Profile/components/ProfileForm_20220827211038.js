        ...
        <>
            <Col>
                ...
                <Form className="d-flex flex-column">
                    ...
                    <h4 className="mb-2 mt-2 text-primary"> Personal details </h4>
                    <Card>
                        <Card.Body>
                            <Row>
                                <Col md={6}>
                    ...
                    <h4 className="mb-2 mt-2 text-primary"> Address details </h4>
                    ...
                    <h4 className="mb-2 mt-2 text-primary"> Account details </h4>
