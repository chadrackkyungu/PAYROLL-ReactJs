                        ...
                        <Form className="d-flex flex-column">
                            ...
                            <Row>
                                <Col md={6}>
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="credit-card" />
                                        <Form.Control type="text" placeholder="Name" defaultValue="Blanch" name="accountName" />
                                    </div>
                                ...
                                <Col md={6}>
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="credit-card" />
                                        <Form.Control type="text" placeholder="Username" defaultValue="Lwazi" name="branchName" />
                                    </div>
