    ...
    return (
        <>
            <Col>
                            ...
                            <Row>
                                <Col md={6}>
                                    ...
                                    <div className="mb-3 filled">
                                        ...
                                        <Form.Control type="text" placeholder="ID Number" defaultValue="Blanch" name="IdNumber" value={values.handleChange} />
                                    </div>
                                ...
                                <Col md={6}>
                                    ...
                                    <div className="mb-3 filled">
                                        ...
                                        <Form.Control type="date" placeholder="date of birth" name="dateOfBirth" value={values.handleChange} />
                                    </div>

                                    <label htmlFor="">Language</label>
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="web" />
                                        <Select classNamePrefix="react-select" options={languageOptions} value={values.languageValue} onChange={setLanguageValue} />
                                    </div>
                                </Col>
                                ...
                                <div className="mb-3 filled">
                                    <CsLineIcons icon="user" />
                                    <Select classNamePrefix="react-select" options={materialOptions} value={values.materialValue} onChange={setMaterialValue} placeholder="Select" />
                                </div>
                            </Row>
                        </Card.Body>
                    </Card>
                            ...
                            <Row>
                                <Col md={6}>
                                    ...
                                    <div className="mb-3 filled">
                                        ...
                                        <Form.Control type="text" placeholder="21 Doris Street" defaultValue="21 Doris Street" name="streetAddress" value={values.handleChange} />
                                    </div>

                                    <label htmlFor="">City</label>
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="pin" />
                                        <Form.Control type="text" placeholder="Johannesburg" defaultValue="Johannesburg" name="city" value={values.handleChange} />
                                    </div>

                                    <label htmlFor="">Country</label>
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="web" />
                                        <Form.Control type="text" placeholder="South Africa" defaultValue="South Africa" name="country" value={values.handleChange} />
                                    </div>
                                </Col>
                                ...
                                <Col md={6}>
                                    ...
                                    <div className="mb-3 filled">
                                        ...
                                        <Form.Control type="number" placeholder="14" defaultValue="14" name="houseNumber" value={values.handleChange} />
                                    </div>

                                    <label htmlFor="">ZipCode</label>
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="web" />
                                        <Form.Control type="number" placeholder="2001" defaultValue="2001" name="zipCode" value={values.handleChange} />
                                    </div>

                                    <label htmlFor="">State / Province</label>
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="web" />
                                        <Form.Control type="text" placeholder="Gauteng" defaultValue="Gauteng" name="stateProvince" value={values.handleChange} />
                                    </div>
                                </Col>
                            </Row>
                        </Card.Body>
                            ...
                            <Row>
                                <Col md={6}>
                                    ...
                                    <div className="mb-3 filled">
                                        ...
                                        <Form.Control type="text" placeholder="Account Name" defaultValue="Blanch" name="accountName" value={values.handleChange} />
                                    </div>
                                ...
                                <Col md={6}>
                                    ...
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="credit-card" />
                                        <Form.Control type="text" placeholder="Branch Name" defaultValue="Lwazi" name="branchName" value={values.handleChange} />
                                    </div>

                                    <label htmlFor="">Account Number</label>
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="money" />
                                        <Form.Control type="number" placeholder="89234643452345" defaultValue="89234643452345" name="accountNumber" value={values.handleChange} />
                                    </div>
                                </Col>
                            </Row>
                        </Card.Body>
                ...
                <Button variant="primary mt-4" type="submit">Update</Button>
