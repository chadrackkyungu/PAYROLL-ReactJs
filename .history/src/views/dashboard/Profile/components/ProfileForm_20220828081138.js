                            ...
                            <Row>
                                ...
                                <Col md={6}>
                                    ...
                                    <div className="mb-3 filled">
                                        ...
                                        <Form.Control type="date" placeholder="date of birth" name="dateOfBirth" value={values.dateOfBirth} />
                                    ...
                                    <div className="mb-3 filled">
                                        ...
                                        <Select classNamePrefix="react-select" options={languageOptions} value={values.languageValue} onChange={setLanguageValue} name="language" />
                                ...
                                <div className="mb-3 filled">
                                    <CsLineIcons icon="user" />
                                    <Select classNamePrefix="react-select" options={materialOptions} value={values.materialStatusValue} onChange={selectMaterialStatusOnChange} placeholder="Select" name="materialStatus" />
                        ...
                        <Card.Body>
                            <Row>
                                <Col md={6}>
                                    ...
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="credit-card" />
                                        <Select classNamePrefix="react-select" options={typeOptions} value={typeValue} onChange={setTypeValue} placeholder="Select" name="type" />
