...
const AccountSettings = () => {
    ...
    const birthDateOnChange = (date) => {
        setFieldValue('leaveStartDate', new Date(date));
    };
                            ...
                            <Row>
                                ...
                                <Col md={6}>
                                    ...
                                    <div className="mb-3 filled">
                                        ...
                                        <DatePicker className="form-control" name="leaveStartDate" selected={values.dateOfBirth} onChange={birthDateOnChange} placeholderText="Start Date" />
                                    ...
                                    <div className="mb-3 filled">
                                        ...
                                        <Select classNamePrefix="react-select" options={languageOptions} value={languageValue} onChange={setLanguageValue} name="language" />
