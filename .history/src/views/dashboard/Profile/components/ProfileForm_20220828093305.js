...
const AccountSettings = () => {
    ...
    const validationSchema = Yup.object().shape({
        IdNumber: Yup.number().max(15).nullable().required('ID Number is required'),
        phoneNumber: Yup.number().max(10).nullable().required('Phone Number is required'),
        ...
        accountNumber: Yup.number().max(15).nullable().required('Account Number is required'),
