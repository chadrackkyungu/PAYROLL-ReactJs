...
import { validationSchema, initialValues, onThumbChangeClick, changeThumb } from './Validation';
...
const AccountSettings = () => {
    ...
    onThumbChangeClick(refFileUpload)
    const [thumb, setThumb] = useState('/img/profile/profile-1.webp');
    changeThumb(changeThumbe(event), setThumb)
        ...
        <>
            <Form onSubmit={handleSubmit} className="d-flex flex-column tooltip-end-top">
                ...
                <div className="m-3 mx-auto position-relative" id="imageUpload">
                    ...
                    <Form.Control type="file" ref={refFileUpload} className="file-upload d-none" accept="image/*" onChange={changeThumbe} />
                </div>
