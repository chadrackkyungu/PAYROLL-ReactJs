...
const AccountSettings = () => {
    ...
    const validationSchema = Yup.object().shape({
        // IdNumber: Yup.number().nullable().required('ID Number is required').min(12).max(16),
        ...
        // phoneNumber: Yup.number().nullable().required('Phone Number is required').min(10).max(13),
        ...
        // accountName: Yup.string().nullable().required('Account Name is required').min(3).max(50),
        ...
        // accountNumber: Yup.number().nullable().required('Account Number is required').min(12).max(16),
    ...
    return (
        <>
            <Form onSubmit={handleSubmit} className="d-flex flex-column tooltip-end-top">
                ...
                <Button type="submit" variant="primary mt-4" classsName="w-25">Update</Button>
            </Form>
        </>
    );
};
