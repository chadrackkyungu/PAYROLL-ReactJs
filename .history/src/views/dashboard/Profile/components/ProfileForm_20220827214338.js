                            ...
                            <Row>
                                <Col md={6}>
                                    ...
                                    <div className="mb-3 filled">
                                        ...
                                        <Form.Control type="text" placeholder="ID Number" defaultValue="Blanch" name="IdNumber" value={handleChange} />
                                    </div>
                                ...
                                <Col md={6}>
                                    ...
                                    <div className="mb-3 filled">
                                        ...
                                        <Form.Control type="date" placeholder="date of birth" name="dateOfBirth" value={handleChange} />
                                    </div>
                            ...
                            <Row>
                                <Col md={6}>
                                    ...
                                    <div className="mb-3 filled">
                                        ...
                                        <Form.Control type="text" placeholder="21 Doris Street" defaultValue="21 Doris Street" name="streetAddress" value={handleChange} />
                                    </div>

                                    <label htmlFor="">City</label>
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="pin" />
                                        <Form.Control type="text" placeholder="Johannesburg" defaultValue="Johannesburg" name="city" value={handleChange} />
                                    </div>

                                    <label htmlFor="">Country</label>
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="web" />
                                        <Form.Control type="text" placeholder="South Africa" defaultValue="South Africa" name="country" value={handleChange} />
                                    </div>
                                </Col>
                                ...
                                <Col md={6}>
                                    ...
                                    <div className="mb-3 filled">
                                        ...
                                        <Form.Control type="number" placeholder="14" defaultValue="14" name="houseNumber" value={handleChange} />
                                    </div>

                                    <label htmlFor="">ZipCode</label>
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="web" />
                                        <Form.Control type="number" placeholder="2001" defaultValue="2001" name="zipCode" value={handleChange} />
                                    </div>

                                    <label htmlFor="">State / Province</label>
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="web" />
                                        <Form.Control type="text" placeholder="Gauteng" defaultValue="Gauteng" name="stateProvince" value={handleChange} />
                                    </div>
                                </Col>
                            </Row>
                        </Card.Body>
                            ...
                            <Row>
                                <Col md={6}>
                                    ...
                                    <div className="mb-3 filled">
                                        ...
                                        <Form.Control type="text" placeholder="Account Name" defaultValue="Blanch" name="accountName" value={handleChange} />
                                    </div>
                                ...
                                <Col md={6}>
                                    ...
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="credit-card" />
                                        <Form.Control type="text" placeholder="Branch Name" defaultValue="Lwazi" name="branchName" value={handleChange} />
                                    </div>

                                    <label htmlFor="">Account Number</label>
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="money" />
                                        <Form.Control type="number" placeholder="89234643452345" defaultValue="89234643452345" name="accountNumber" value={handleChange} />
                                    </div>
                                </Col>
                            </Row>
                        </Card.Body>
