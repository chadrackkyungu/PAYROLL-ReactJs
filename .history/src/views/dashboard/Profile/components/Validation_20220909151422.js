...
export const UpdateValidationSchema = Yup.object().shape({
    ...
    branchName: Yup.string().nullable().required('Branch Name is required'),
    accountNumber: Yup.number().nullable().required('Account Number is required'),
    photo: Yup.string().nullable().required('User Profile is required'),
    email: Yup.string().email('Must be a valid email').max(255).required('Email is required'),
    employeeNumber: Yup.number().nullable().required('Employee Number is required'),
    firstName: Yup.string().nullable().required('First Name is required'),
    lastName: Yup.string().nullable().required('Last Name is required'),
    role: Yup.string().max(6).required('Role is required'),
    startDate: Yup.date().nullable().required('Employee starting date is required'),
    uploadDocPic: Yup.string().nullable().required('document 1 is required'),
    uploadDocPic2: Yup.string().nullable().required('document 2 is required'),
    uploadDocPic3: Yup.string().nullable().required('document 3 is required'),
});
