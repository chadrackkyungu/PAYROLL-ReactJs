                                ...
                                <table className="table align-middle table-nowrap mb-0">
                                    <thead className="table-light">
                                        <tr>
                                            ...
                                            <th className="align-middle">Employee Number</th>
                                            ...
                                            <tr key={"_tr_" + key}>
                                                <td>
                                                    <div className="form-check font-size-16">
                                                        <input type="checkbox" className="form-check-input" id={empl.id} />
                                                        <label className="form-check-label" htmlFor={empl.id}> &nbsp;</label>
                                                    </div>
                                                </td>
                                                <td>{empl.id}</td>
                                                <td>{empl.leaveStartDate}</td>
                                                <td>{empl.leaveEndDate}</td>
                                                <td>{empl.leaveType}</td>

                                                <td><Badge className={
                                                    empl.status === "pending" ? "bg-warning" : empl.status === "decline" ? "bg-danger" : "bg-success"
                                                } pill>{empl.status}</Badge>
                                                </td>

                                                <td className="cursor-pointer"
                                                    onClick={() => {
                                                        setNExample(true)
                                                        setViewLeave(empl?.id)
                                                    }}>
                                                    <Badge> View </Badge>
                                                </td>

                                                <td>
                                                    <Badge className={`px-3 pe-auto cursor-pointer ${empl.status === "pending" ? "bg-primary" : "bg-light text-danger"}`}
                                                        onClick={() => {
                                                    ...
                                                    > {empl.status === "pending" ? "Edit" : "no action"} </Badge>
                                                </td>
                                            </tr>
                                        ))}
                                    </tbody>
