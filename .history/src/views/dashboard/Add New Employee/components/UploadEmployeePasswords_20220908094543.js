...
const UpdateUserPassword = () => {
    ...
    return (
        <div className="wizard wizard-default">
            ...
            <h5 className="mb-2  text-primary py-4 text-center mt-5"> <b> Update Password  </b> </h5>

            <Form onSubmit={handleUpdatePassword} className="d-flex flex-column tooltip-end-top">
                <Row>
                    <Col md={6}>
                        <div className="mb-3 filled">
