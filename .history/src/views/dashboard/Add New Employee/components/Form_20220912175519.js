...
const WizardBasic = () => {
    ...
    const [genderValue, setGenderValue] = useState(genderOptions);
    ...
    const [materialStatusValue, setMaterialStatusValue] = useState(materialOptions);
    ...
    const [languageValue, setLanguageValue] = useState(languageOptions);
    ...
    const [roleValue, setRoleValue] = useState(roleOptions);
