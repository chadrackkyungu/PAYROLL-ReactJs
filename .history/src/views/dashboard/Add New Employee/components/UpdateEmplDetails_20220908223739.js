...
const UpdateUserDetails = ({ details }) => {
    ...
    return (
        <div className="wizard wizard-default">
            ...
            <Form onSubmit={handleSubmit} className="d-flex flex-column tooltip-end-top" encType="multipart/form-data">
                ...
                <div className="">
                    ...
                    <Row>
                        ...
                        <div className="mb-3 filled">
                            <Form.Control type="file" name="uploadDocPic" accept='image/*' onChange={imageDocument} />
                            {errors.uploadDocPic && touched.uploadDocPic && <div className="error">{errors.uploadDocPic}</div>}
                        </div>
                        <div className="mb-3 filled">
                            <Form.Control type="file" name="uploadDocPic2" accept='image/*' onChange={imageDocument2} />
                            {errors.uploadDocPic2 && touched.uploadDocPic2 && <div className="error">{errors.uploadDocPic2}</div>}
                        </div>
                        <div className="mb-3 filled">
                            <Form.Control type="file" name="uploadDocPic3" accept='image/*' onChange={imageDocument3} />
