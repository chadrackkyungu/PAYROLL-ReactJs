                                ...
                                <Row>
                                    <Col md={6}>
                                        <div className="mb-3 filled">
                                            ...
                                            <Form.Control type="text" placeholder="ID Number" value={values.IdNumber} name="IdNumber" onChange={handleChange} />
                                    ...
                                    <Col md={6}>
                                        <div className="mb-3 filled">
                                            ...
                                            <DatePicker className="form-control" selected={values.dateOfBirth} name="dateOfBirth" placeholderText="Date of birth" />
