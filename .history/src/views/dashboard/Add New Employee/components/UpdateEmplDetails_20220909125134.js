        ...
        <div className="wizard wizard-default">
            ...
            <Form onSubmit={handleSubmit} className="d-flex flex-column tooltip-end-top">
                ...
                <div className="">
                    ...
                    <br />
                    <Form.Control value={ } name="uploadDocPic2" type="file" onChange={uploadDocuments2} accept="image/*" />
                    <br />
                    <Form.Control value={ } name="uploadDocPic3" type="file" onChange={uploadDocuments3} accept="image/*" />
