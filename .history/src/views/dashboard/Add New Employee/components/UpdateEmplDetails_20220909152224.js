...
const UpdateUserDetails = ({ details }) => {
    ...
    const initialValues = {
        ...
        uploadDocPic: details[0].uploadDocPic[0],
        uploadDocPic2: details[0].uploadDocPic[1],
        uploadDocPic3: details[0].uploadDocPic[2],
    };
        ...
        <div className="wizard wizard-default">
            ...
            <Form onSubmit={handleSubmit} className="d-flex flex-column tooltip-end-top">
                ...
                <div className="m-3 mx-auto position-relative mt-5" id="imageUpload">
                    <img src={profile === undefined ? `${urlUser}/${details[0].photo}` : profile} alt="user" className="rounded-xl border border-separator-light border-4 sw-11 sh-11" id="contactThumbModal" />
                ...
                <div className="">
                    ...
                    <div className="my-5">
                        <img src={doc1 === undefined ? `${urlDoc}${details[0]?.uploadDocPic[0]}` : doc1} className="rounded mb-1 float-start sw-18 mx-1" alt="docs image" />
                        <img src={doc2 === undefined ? `${urlDoc}${details[0]?.uploadDocPic[1]}` : doc2} className="rounded mb-1 float-start sw-18 mx-1" alt="docs image" />
                        <img src={doc3 === undefined ? `${urlDoc}${details[0]?.uploadDocPic[2]}` : doc3} className="rounded mb-1 float-start sw-18 mx-1" alt="docs image" />
                    </div>

                    <div className="mt-5">
                        <div className="mb-3 filled">
                            <Form.Control name="uploadDocPic" type="file" onChange={uploadDocuments} accept="image/*" required />
                            {errors.uploadDocPic && touched.uploadDocPic && <div className="error">{errors.uploadDocPic}</div>}
                        </div>

                        <div className="mb-3 filled">
                            <Form.Control name="uploadDocPic2" type="file" onChange={uploadDocuments2} accept="image/*" required />
                            {errors.uploadDocPic2 && touched.uploadDocPic2 && <div className="error">{errors.uploadDocPic2}</div>}
                        </div>

                        <div className="mb-3 filled">
                            <Form.Control name="uploadDocPic3" type="file" onChange={uploadDocuments3} accept="image/*" required />
                            {errors.uploadDocPic3 && touched.uploadDocPic3 && <div className="error">{errors.uploadDocPic3}</div>}
                        </div>
                    </div>
