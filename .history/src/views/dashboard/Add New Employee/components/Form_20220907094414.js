                        ...
                        <Step id="step1" name="First" desc="First description">
                            ...
                            <Row>
                                <Col md={6}>
                                    <div className="mb-3 filled">
                                        ...
                                        {errors.password && touched.employeeNumber && <div className="error">{errors.password}</div>}
                                    </div>
                                </Col>
                                <Col md={6}>
                                    <div className="mb-3 filled">
                            ...
                            <Row>
                                <Col md={6}>
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="calendar" />
                                        <DatePicker className="form-control" name="startDate" selected={values.startDate} onChange={startDateOnChange} placeholderText="Date of birth" />
