...
import DropzoneColumnPreview from "./DropzoneColumnPreview";
...
const UpdateUserDetails = ({ details }) => {
    ...
    const onSubmit = async (values) => {
        ...
        formdata.append("uploadDocPic", imageDoc);
        formdata.append("uploadDocPic", imageDoc);
        formdata.append("uploadDocPic", imageDoc);
        ...
        <div className="wizard wizard-default">
            ...
            <Form onSubmit={handleSubmit} className="d-flex flex-column tooltip-end-top">
                ...
                <div className="">
                    ...
                    <Form.Control name="uploadDocPic" type="file" onChange={uploadDocuments2} accept="image/*" />
                    <Form.Control name="uploadDocPic" type="file" onChange={uploadDocuments3} accept="image/*" />
