...
const UpdateUserDetails = ({ details }) => {
    ...
    const [thumb, setThumb] = useState(urlUser);
        ...
        <div className="wizard wizard-default">
            ...
            <Form onSubmit={handleSubmit} className="d-flex flex-column tooltip-end-top">
                ...
                <div className="m-3 mx-auto position-relative mt-5" id="imageUpload">
                    <img src={`${urlUser}/${details[0].photo}`} alt="user" className="rounded-xl border border-separator-light border-4 sw-11 sh-11" id="contactThumbModal" />
                ...
                <div className="">
                    ...
                    <Form.Control defaultValue={"details[0].uploadDocPic"} name="uploadDocPic" type="file" onChange={uploadDocuments} accept="image/*" />
                    <br />
                    <Form.Control defaultValue={"details[0]?.uploadDocPic"} name="uploadDocPic2" type="file" onChange={uploadDocuments2} accept="image/*" />
                    <br />
                    <Form.Control defaultValue={"details[0]?.uploadDocPic"} name="uploadDocPic3" type="file" onChange={uploadDocuments3} accept="image/*" />
