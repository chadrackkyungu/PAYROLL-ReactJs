    ...
    return (
        <div className="wizard wizard-default">
            ...
            <Form onSubmit={handleSubmit} className="d-flex flex-column tooltip-end-top">
                ...
                <h5 className="mb-2 text-primary py-4"> Personal details </h5>
                <div className="sh-30">
                    <Row>
                        <Col md={6}>
                ...
                <h5 className="mb-2 text-primary py-2"> Employee details </h5>
                ...
                <h5 className="mb-2  text-primary py-2"> Account details </h5>
                <div className="sh-30">
