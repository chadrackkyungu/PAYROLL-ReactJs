        ...
        <div className="wizard wizard-default">
            ...
            <Form onSubmit={handleSubmit} className="d-flex flex-column tooltip-end-top">
                ...
                <div className="">
                    ...
                    <Form.Control value={details[0]?.uploadDocPic[0]} name="uploadDocPic" type="file" onChange={uploadDocuments} accept="image/*" />
                    <br />
                    <Form.Control value={details[0]?.uploadDocPic[1]} name="uploadDocPic2" type="file" onChange={uploadDocuments2} accept="image/*" />
                    <br />
                    <Form.Control value={details[0]?.uploadDocPic[2]} name="uploadDocPic3" type="file" onChange={uploadDocuments3} accept="image/*" />
