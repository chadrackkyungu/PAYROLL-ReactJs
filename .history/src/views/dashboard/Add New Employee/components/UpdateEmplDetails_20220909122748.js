...
const UpdateUserDetails = ({ details }) => {
    ...
    const url = `http://localhost:5000/img/users/${details[0].photo}`

    console.log(details[0].uploadDocPic);
        ...
        <div className="wizard wizard-default">
            ...
            <Form onSubmit={handleSubmit} className="d-flex flex-column tooltip-end-top">
                ...
                <div className="m-3 mx-auto position-relative mt-5" id="imageUpload">
                    <img src={url} alt="user" className="rounded-xl border border-separator-light border-4 sw-11 sh-11" id="contactThumbModal" />
                ...
                <div className="">
                    ...
                    <div className="mt-4">
                        ...
                        {details[0].uploadDocPic.map((img, i) => (
                            <img key={i} src="/img/product/small/product-2.webp" className="rounded mb-1 float-start sw-18" alt="card image" />
                        ))}
                    </div>
