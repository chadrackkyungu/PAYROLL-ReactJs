...
const UpdateUserDetails = ({ details }) => {
    ...
    const onSubmit = async (values) => {
        ...
        formdata.append("firstName", "MAGLOIRE");
        formdata.append("lastName", "NkUMWIMBA UPDATE !!!!");
        formdata.append("IdNumber", "895623JHU !!!");
        formdata.append("phoneNumber", "0827000150");
        formdata.append("gender", "female");
        formdata.append("dateOfBirth", "2004-05-22");
        formdata.append("language", "20-05-2000");
        formdata.append("materialStatus", "un maried");
        formdata.append("streetAddress", "21 Alex");
        formdata.append("houseNumber", "5");
        formdata.append("country", "South Africa");
        formdata.append("stateProvince", "Gauteng");
        formdata.append("city", "Johannesburg");
        formdata.append("zipCode", "2001");
        formdata.append("employeeNumber", "5");
        formdata.append("startDate", "2022-05-22");
        formdata.append("uploadDocPic", fileInput.files[0], "/D:/MY PIC/Camera/IMG_20190212_113328.jpg");
        formdata.append("accountName", "lwazi");
        formdata.append("branchName", "braamfontein");
        formdata.append("accountNumber", "123456789987");
        formdata.append("accountType", "savings");
        formdata.append("agreed", "true");
        formdata.append("photo", fileInput.files[0], "/D:/MY PIC/Camera/IMG_20191229_190019.jpg");
        formdata.append("role", "user");
        formdata.append("email", "magloire@gmail.com");
        formdata.append("uploadDocPic", fileInput.files[0], "/D:/MY PIC/DESIGN IMG/ui.png");
        formdata.append("uploadDocPic", fileInput.files[0], "/C:/Users/chadrack/Desktop/CHAD/src/assets/images/gallery/work-5.jpg");
