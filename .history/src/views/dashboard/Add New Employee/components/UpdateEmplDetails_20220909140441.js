...
const UpdateUserDetails = ({ details }) => {
    ...
    const [thumb, setThumb] = useState(); // Photo user profile
    ...
    console.log(details[0].photo);
    console.log(details[0].uploadDocPic[0]);
    console.log(details[0].uploadDocPic[1]);
    console.log(details[0].uploadDocPic[2]);
        ...
        <div className="wizard wizard-default">
            ...
            <Form onSubmit={handleSubmit} className="d-flex flex-column tooltip-end-top">
                ...
                <div className="m-3 mx-auto position-relative mt-5" id="imageUpload">
                    <img src={thumb === undefined ? `${urlUser}/${details[0].photo}` : thumb} alt="user" className="rounded-xl border border-separator-light border-4 sw-11 sh-11" id="contactThumbModal" />
                        ...
                        details[0]?.uploadDocPic?.map((img, i) => {
                            return (
                                <div className="my-5" key={i}>
                                    <img src={`${urlDoc}${img}`} className="rounded mb-1 float-start sw-18 mx-1" alt="docs image" />
                                </div>
                            )
                        })
                    } */}
