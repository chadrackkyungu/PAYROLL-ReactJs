            ...
            <Form onSubmit={handleSubmit} className="d-flex flex-column tooltip-end-top">
                    ...
                    <Row>
                        ...
                        <Col md={6}>
                            <div className="mb-3 filled">
                                ...
                                <DatePicker className="form-control" name="dateOfBirth" selected={new Date(details[0].dateOfBirth)} onChange={birthDateOnChange} placeholderText="Date of birth" />
                ...
                <Row>
                    <Col md={6}>
                        <div className="mb-3 filled">
                            <CsLineIcons icon="calendar" />
                            <DatePicker className="form-control" name="startDate" selected={new Date(details[0].startDate)} onChange={startDateOnChange} placeholderText="Start Date" />
