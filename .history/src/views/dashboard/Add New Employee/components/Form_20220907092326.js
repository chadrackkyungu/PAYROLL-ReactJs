                                ...
                                <Row>
                                    <Col md={6}>
                                        <div className="mb-3 filled">
                                            ...
                                            <Form.Control type="text" placeholder="ID Number" name="firstName" value={values.firstName} onChange={handleChange} />
                                    ...
                                    <Col md={6}>
                                        <div className="mb-3 filled">
                                            <CsLineIcons icon="user" />
                                            <Form.Control type="text" placeholder="ID Number" name="lastName" value={values.lastName} onChange={handleChange} />
