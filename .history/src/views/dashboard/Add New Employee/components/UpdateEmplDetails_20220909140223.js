        ...
        <div className="wizard wizard-default">
            ...
            <Form onSubmit={handleSubmit} className="d-flex flex-column tooltip-end-top">
                ...
                <div className="">
                    ...
                    <div className="my-5" >
                        <img src={`${urlDoc}${details[0]?.uploadDocPic[0]}`} className="rounded mb-1 float-start sw-18 mx-1" alt="docs image" />
                        <img src={`${urlDoc}${details[0]?.uploadDocPic[1]}`} className="rounded mb-1 float-start sw-18 mx-1" alt="docs image" />
                        <img src={`${urlDoc}${details[0]?.uploadDocPic[3]}`} className="rounded mb-1 float-start sw-18 mx-1" alt="docs image" />
                    </div>
