...
const UpdateUserDetails = ({ details }) => {
    ...
    const onSubmit = async (values) => {
        ...
        formdata.append("uploadDocPic", imageDoc.uploadDocPic);
        formdata.append("uploadDocPic", imageDoc.uploadDocPic2);
        formdata.append("uploadDocPic", imageDoc.uploadDocPic3);
