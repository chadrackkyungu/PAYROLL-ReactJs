...
function EmployeesDetails({ details }) {
    ...
    return (
        <div>
            <h4 className="primary"> Personal Details </h4>
            ...
            <h4 className="primary"> Address Details </h4>
            <p> {details[0].city} </p>
            ...
            <h4 className="primary"> Employee Details </h4>
            <p> {details[0].email} </p>
            <p> {details[0].role} </p>
            <p> {details[0].employeeNumber} </p>
            <p> {details[0].startDate} </p>

            <h4 className="primary"> Employee Account Details </h4>
