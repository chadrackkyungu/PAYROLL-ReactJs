                        ...
                        <Step id="step1" name="First" desc="First description">
                            ...
                            <div className="sh-30">
                                ...
                                <Row>
                                    <Col md={6}>
                                        <div className="mb-3 filled">
                                            <CsLineIcons icon="user" />
                                            <Form.Control type="pen" placeholder="ID number" name="IdNumber" value={values.IdNumber} onChange={handleChange} />
                            ...
                            <Row>
                                ...
                                <Col md={6}>
                                    <div className="mb-3 filled">
                                        <CsLineIcons icon="user" />
                                        <Form.Control type="text" placeholder="Employee Role" name="role" value={values.role} onChange={handleChange} />
                            ...
                            <Row>
                                ...
                                <Col md={6}>
                                    <div className="mb-3 filled">
                                        ...
                                        <Form.Control type="number" placeholder="Employee Number" name="employeeNumber" value={values.passwordConfirm} onChange={handleChange} />
