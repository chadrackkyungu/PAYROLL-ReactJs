...
const AdminCards = ({ total, totalYearSal, totalYearOver, total_Monthly_Salary_Overtime }) => {
    ...
    const total_Monthly_Salary_Overtime_res = Math.abs(total_Monthly_Salary_Overtime) > 999 ? Math.sign(totalYearOver) * ((Math.abs(total_Monthly_Salary_Overtime) / 1000).toFixed(1)) + 'k' : Math.sign(total_Monthly_Salary_Overtime) * Math.abs(total_Monthly_Salary_Overtime)
