...
const AdminCards = ({ total, totalYearSal, totalYearOver, total_Monthly_Salary_Overtime, total_Monthly_Salary, total_Monthly_Overtime }) => {
    ...
    const total_Monthly_Overtime_res = Math.abs(total_Monthly_Overtime) > 999 ? Math.sign(total_Monthly_Overtime) * ((Math.abs(total_Monthly_Overtime) / 1000).toFixed(1)) + 'k' : Math.sign(total_Monthly_Overtime) * Math.abs(total_Monthly_Overtime)
                    ...
                    <Card.Body className="py-5">
                        <Row className="g-0 align-items-center">
                            ...
                            <Col xs="auto" className="ps-3">
                                <div className="display-5 text-primary"> R {!totalPay ? 0 : totalPay} </div>
                            </Col>
                        </Row>
                    </Card.Body>
                </Card>
                ...
                <Card>
                    <Card.Body className="py-5">
                        <Row className="g-0 align-items-center">
                            ...
                            <Col xs="auto" className="ps-3">
                                <div className="display-5 text-primary">R {!totalYearSalary ? 0 : totalYearSalary} </div>
                            </Col>
                        </Row>
                    </Card.Body>
                </Card>
                ...
                <Card >
                    <Card.Body className="py-5">
                        <Row className="g-0 align-items-center">
                            ...
                            <Col xs="auto" className="ps-3">
                                <div className="display-5 text-primary">R {!totalYearOvertime ? 0 : totalYearOvertime} </div>
                            </Col>
                        </Row>
                    </Card.Body>
                </Card>
                ...
                <Card>
                    <Card.Body className="py-5">
                        <Row className="g-0 align-items-center">
                            ...
                            <Col xs="auto" className="ps-3">
                                <div className="display-5 text-primary"> R {!total_Monthly_Salary_Overtime_res ? 0 : total_Monthly_Salary_Overtime_res} </div>
                            </Col>
                        </Row>
                    </Card.Body>
                </Card>
                ...
                <Card>
                    <Card.Body className="py-5">
                        <Row className="g-0 align-items-center">
                            ...
                            <Col xs="auto" className="ps-3">
                                <div className="display-5 text-primary">R {!total_Monthly_Salary_res ? 0 : total_Monthly_Salary_res} </div>
                            </Col>
                        </Row>
                    </Card.Body>
                </Card>
                ...
                <Card >
                    <Card.Body className="py-5">
                        <Row className="g-0 align-items-center">
                            ...
                            <Col xs="auto" className="ps-3">
                                <div className="display-5 text-primary">R {!total_Monthly_Overtime_res ? 0 : total_Monthly_Overtime_res} </div>
                            </Col>
                        </Row>
                    </Card.Body>
                </Card>
                ...
                <Card >
                    <Card.Body className="py-5">
                        <Row className="g-0 align-items-center">
                            <Col xs="auto">
                                <div className="bg-gradient-light sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center">
                                    {/* <TbHandClick icon="dollar" className="text-white" /> */}
                                </div>
                            </Col>
                            <Col>
                                <div className="heading mb-0 sh-8 d-flex align-items-center lh-1-25 ps-3"> SARS <TbHandClick icon="dollar" className="text-white" /> </div>
                            </Col>
                            {/* <Col xs="auto" className="ps-3">
                                <div className="display-5 text-primary">R {!total_Monthly_Overtime_res ? 0 : total_Monthly_Overtime_res} </div>
                            </Col> */}
