...
const Cards = () => {
    ...
    const addSalary = salary.reduce((a, b) => a + b); console.log(addSalary);
    const addOvertime = overtimeSalary.reduce((a, b) => a + b); console.log(addOvertime);
                    ...
                    <Card.Body className="py-4">
                        <Row className="g-0 align-items-center">
                            ...
                            <Col xs="auto" className="ps-3">
                                <b className="display-5 text-primary"> R {totalPayment}</b>
                            </Col>
                        </Row>
                    </Card.Body>
                </Card>
