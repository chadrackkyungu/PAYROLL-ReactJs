...
const Employees = () => {
    ...
    const employeeDet = payment?.filter(employee => employee._id === ViewEmployee);
                                        ...
                                        {payment?.map((empl, key) => {
                                            return (
                                                <tr key={"_tr_" + key} >
                                                    ...
                                                    <td><Badge className={`${empl?.status === 'pending' ? "bg-primary cursor-pointer" : "bg-primary cursor-pointer"} `}
                                                        onClick={() => {
                                                            setLExample(true)
                                                            setViewEmployee(empl?._id)
                                                        }}> <CsLineIcons icon="eye" size="14" /> {empl?.status}  </Badge>
                                                    </td>
