...
function UpdatePaymentForm({ details }) {
    ...
    const onSubmit = async (values) => {
        ...
        fetch(`http://localhost:5000/api/v1/payments/${details[0]?._id}`, requestOptions)
    ...
    const [receipt, setReceipt] = useState(details[0].paymentRecept)
                    ...
                    <Row>
                        ...
                        <Form onSubmit={handleSubmit} className="tooltip-end-top">
                            ...
                            <Row>
                                ...
                                <div className="mb-3 filled">
                                    <img src={` ${receipt !== undefined ? receipt : `http://localhost:5000/img/recept/${details[0].paymentRecept}`} `} className="rounded mb-1 float-start sw-18 mx-1" alt="docs image" />
                                </div>
