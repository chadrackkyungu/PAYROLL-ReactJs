            ...
            <div className="mx-2">
                ...
                <Row>
                    ...
                    <Col md={6}>
                        ...
                        <p> ID Number :  {details[0].user.accountName} </p>
                        <p> ID Number :  {details[0].user.accountNumber} </p>
                        <p> ID Number :  {details[0].user.accountType} </p>
                        <p> ID Number :  {details[0].user.branchName} </p>
                        <p> ID Number :  {details[0].user.email} </p>
                        <p> ID Number :  {details[0].user.firstName}  {details[0].lastName}</p>
                        <p> ID Number :  {details[0].user.phoneNumber} </p>
