...
const Employees = () => {
    ...
    const deleteFunc = async () => {
        ...
        fetch(`https://polar-basin-47052.herokuapp.com/api/v1/payments/${paymentdet[0]?._id}`, deleteRequest)
            .then(response => response.json())
            .then(result => {
    ...
    const UpdateStatus = () => {
        ...
        fetch(`https://polar-basin-47052.herokuapp.com/api/v1/payments/${paymentdet[0]?._id}/status`, requestUpdateStatus)
            .then(response => response.json())
            .then(result => {
