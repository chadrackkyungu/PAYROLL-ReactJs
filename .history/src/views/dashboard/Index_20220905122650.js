...
const Dashboard = () => {
    ...
    const totalSalaryFeb = JanuaryMonth?.reduce((a, b) => a + b); console.log("January sum : ", totalSalaryFeb)
    const totalOverTimeFeb = januaryOverMonth?.reduce((a, b) => a + b); console.log("January sum : ", totalOverTimeFeb)
