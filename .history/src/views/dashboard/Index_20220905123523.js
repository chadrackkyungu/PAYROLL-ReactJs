...
import { getCurrentMonth, getJanuary, getFebuary, getMarch } from './Home/AllTotalMonthlySal';
...
const Dashboard = () => {
    ...
    const totalSalaryJanuary = JanuaryMonth?.reduce((a, b) => a + b); console.log(totalSalaryJanuary);
    ...
    const totalSalaryFeb = febuaryMonth?.reduce((a, b) => a + b); console.log(totalSalaryFeb);
    ...
    const totalSalaryMarch = marchMonth?.reduce((a, b) => a + b); console.log(totalSalaryMarch);
