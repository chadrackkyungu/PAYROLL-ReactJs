...
const Dashboard = () => {
    ...
    const febuaryMonth = febuary?.map(pay => pay?.salaryAmount); console.log("feb : ", febuaryMonth)
    const febuaryOverMonth = febuary?.map(pay => pay?.overTimeAmount); console.log("feb : ", febuaryOverMonth)
    const totalSalaryFeb = febuaryMonth?.reduce((a, b) => a + b); console.log("feb sum : ", totalSalaryFeb)
    const totalOverTimeFeb = febuaryOverMonth?.reduce((a, b) => a + b); console.log("feb sum : ", totalOverTimeFeb)
